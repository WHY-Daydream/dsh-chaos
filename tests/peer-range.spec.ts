...
/**
 * The supported DSH runtime window (PCA-02 audit draft, frozen into v0.1.1):
 ...
 * bare `>=0.0.1-rc.1` floor (published v0.1.0) excludes every 0.1.x line
...
const UNION_RC3 = '>=0.0.1-rc.3 <0.1.0-0 || >=0.1.0-0 <0.2.0-0 || >=0.1.1-0 <0.2.0-0 || >=0.1.2-0 <0.2.0-0 || >=0.1.3-0 <0.2.0-0'
...
describe('peer range @deepseek-ai/dsh-* (latest-DSH compatibility, PCA-02 frozen)', () => {
  it('declares the audited per-line union (no bare floors, no future-tuple promises)', () => {
    ...
    expect(peers['@deepseek-ai/dsh-llm']).toBe(UNION_RC1)
    expect(peers['@deepseek-ai/dsh-tools']).toBe(UNION_RC1)
    // timeout-policy keeps its own independent floor (rc.3) — never inherited
    expect(peers['@deepseek-ai/dsh-tool-call-timeout-policy']).toBe(UNION_RC3)
  ...
  it.each([
    // 0.0.1 line (published era), then 0.1.x lines incl. in-source 0.1.3-alpha.1
    ...
    ['dsh-llm', '0.0.1-rc.1', UNION_RC1], ['dsh-llm', '0.0.1-rc.5', UNION_RC1],
    ['dsh-llm', '0.1.0-rc.6', UNION_RC1], ['dsh-llm', '0.1.0-rc.8', UNION_RC1],
    ['dsh-llm', '0.1.1-rc.2', UNION_RC1], ['dsh-llm', '0.1.2-alpha.5', UNION_RC1],
    ['dsh-llm', '0.1.2-rc.1', UNION_RC1], ['dsh-llm', '0.1.3-alpha.1', UNION_RC1],
    ['dsh-tools', '0.0.1-rc.1', UNION_RC1], ['dsh-tools', '0.0.1-rc.5', UNION_RC1],
    ['dsh-tools', '0.1.0-rc.6', UNION_RC1], ['dsh-tools', '0.1.0-rc.8', UNION_RC1],
    ['dsh-tools', '0.1.1-rc.2', UNION_RC1], ['dsh-tools', '0.1.2-alpha.5', UNION_RC1],
    ['dsh-tools', '0.1.2-rc.1', UNION_RC1], ['dsh-tools', '0.1.3-alpha.1', UNION_RC1],
    // timeout-policy: earliest published is rc.3 — its own floor
    ['dsh-tool-call-timeout-policy', '0.0.1-rc.3', UNION_RC3], ['dsh-tool-call-timeout-policy', '0.0.1-rc.5', UNION_RC3],
    ['dsh-tool-call-timeout-policy', '0.1.0-rc.6', UNION_RC3], ['dsh-tool-call-timeout-policy', '0.1.0-rc.8', UNION_RC3],
    ['dsh-tool-call-timeout-policy', '0.1.1-rc.2', UNION_RC3], ['dsh-tool-call-timeout-policy', '0.1.2-alpha.5', UNION_RC3],
    ['dsh-tool-call-timeout-policy', '0.1.2-rc.1', UNION_RC3], ['dsh-tool-call-timeout-policy', '0.1.3-alpha.1', UNION_RC3],
  ...
  it.each([
    ...
    ['dsh-tool-call-timeout-policy', '0.0.1-rc.1', UNION_RC3],
    ['dsh-tool-call-timeout-policy', '0.0.1-rc.2', UNION_RC3],
    ['dsh-invariants', '0.2.0-alpha.1', UNION_RC1],
    ['dsh-invariants', '0.2.0', UNION_RC1],
    ['dsh-llm', '0.2.0-alpha.1', UNION_RC1],
    ['dsh-tools', '0.2.0', UNION_RC1],
    ['dsh-tool-call-timeout-policy', '0.2.0-alpha.1', UNION_RC3],
    ['dsh-tool-call-timeout-policy', '0.2.0', UNION_RC3],
